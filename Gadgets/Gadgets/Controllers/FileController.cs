...
namespace Gadgets.Controllers
{
    ...
    public class FileController : Controller
    {
        ...
        public FileController(IHostingEnvironment hostingEnvironment)
        {
            ...
            _savePath = _hostingEnvironment.WebRootPath + Path.DirectorySeparatorChar + Path.DirectorySeparatorChar + "upload" + Path.DirectorySeparatorChar;
            ...
            try
            {
                ...
                foreach (IFormFile formFile in file)
                {
                    if (formFile.Length > 0)
                    {
                        ...
                        string fileExtension = formFile.FileName.Substring(formFile.FileName.LastIndexOf(".") + 1); // 获取文件Name后缀
