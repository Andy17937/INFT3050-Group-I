<template>
  <el-aside class="index-aside" height="100vh" width="230px">
    <div class="index-aside-inner menulist" style="height:100%">
      <div v-for="item in menuList" :key="item.roleName" v-if="role==item.roleName" class="menulist-item" style="height:100%;broder:0;background-color:#E7433E">
        <div class="menulistImg" style="backgroundColor:#E7433E;padding:25px 0" v-if="false && menulistStyle == 'vertical'">
        ...
        <el-menu mode="vertical" :unique-opened="true" class="el-menu-demo" style="height:100%;" background-color="#E7433E" text-color="#F2F8F2" active-text-color="#9AF4F4" default-active="0">
          <el-menu-item index="0" :style="menulistBorderBottom" @click="menuHandler('')"><i v-if="true" class="el-icon-s-home" />Home</el-menu-item>
          <el-submenu :index="1+''" :style="menulistBorderBottom">
            ...
            <el-menu-item :index="1-2" @click="menuHandler('center')">个人Message</el-menu-item>
          </el-submenu>
      ...
      this.$nextTick(()=>{
        document.querySelectorAll('.menulist .el-menu-item').forEach(el=>{
          ...
          el.addEventListener("mouseleave", e => {
            e.stopPropagation()
            el.style.backgroundColor = "#E7433E"
          })
