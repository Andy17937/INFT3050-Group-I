      ...
      this.$refs["ruleForm"].validate(valid => {
        if (valid) {
          ...
          if (this.ruleForm.password != password) {
            this.$message.error("原Password错误");
            return;
          }
