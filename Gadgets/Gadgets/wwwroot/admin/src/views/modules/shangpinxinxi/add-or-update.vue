<template>
  <div class="addEdit-block">
    ...
    >
      <el-row>
                        <el-col :span="24">  
        <el-form-item class="upload" v-if="type!='info' && !ro.shangpintupian" label="Item图片" prop="shangpintupian">
          <file-upload
          tip="点击上传Item图片"
          action="file/upload"
          :limit="3"
        ...
        <div v-else>
          <el-form-item v-if="ruleForm.shangpintupian" label="Item图片" prop="shangpintupian">
            <img style="margin-right:20px;" v-bind:key="index" v-for="(item,index) in ruleForm.shangpintupian.split(',')" :src="item" width="100" height="100">
                                    ...
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="ItemName" prop="shangpinmingcheng">
          <el-input v-model="ruleForm.shangpinmingcheng" 
              placeholder="ItemName" clearable  :readonly="ro.shangpinmingcheng"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="ItemName" prop="shangpinmingcheng">
              <el-input v-model="ruleForm.shangpinmingcheng" 
                placeholder="ItemName" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="Category" prop="shangpinfenlei">
          <el-input v-model="ruleForm.shangpinfenlei" 
              placeholder="Category" clearable  :readonly="ro.shangpinfenlei"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="Category" prop="shangpinfenlei">
              <el-input v-model="ruleForm.shangpinfenlei" 
                placeholder="Category" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="Item Details" prop="shangpinxiangqing">
          <el-input v-model="ruleForm.shangpinxiangqing" 
              placeholder="Item Details" clearable  :readonly="ro.shangpinxiangqing"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="Item Details" prop="shangpinxiangqing">
              <el-input v-model="ruleForm.shangpinxiangqing" 
                placeholder="Item Details" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="Spot Amount" prop="xianhuoshuliang">
          <el-input v-model="ruleForm.xianhuoshuliang" 
              placeholder="Spot Amount" clearable  :readonly="ro.xianhuoshuliang"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="Spot Amount" prop="xianhuoshuliang">
              <el-input v-model="ruleForm.xianhuoshuliang" 
                placeholder="Spot Amount" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="Vendor inventory" prop="gongyingshangkucun">
          <el-input v-model="ruleForm.gongyingshangkucun" 
              placeholder="Vendor inventory" clearable  :readonly="ro.gongyingshangkucun"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="Vendor inventory" prop="gongyingshangkucun">
              <el-input v-model="ruleForm.gongyingshangkucun" 
                placeholder="Vendor inventory" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                                                                                                                                            <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="Price" prop="price">
          <el-input v-model="ruleForm.price" 
              placeholder="Price" clearable  :readonly="ro.price"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="Price" prop="price">
              <el-input v-model="ruleForm.price" 
                placeholder="Price" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                              </el-row>
...
export default {
  data() {
	...
	xianhuoshuliang : false,
	gongyingshangkucun : false,
	thumbsupnum : false,
	crazilynum : false,
	clicktime : false,
	clicknum : false,
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.shangpinxiangqing = true;
            continue;
	            	            ...
	            	            if(o=='xianhuoshuliang'){
            this.ruleForm.xianhuoshuliang = obj[o];
	    this.ro.xianhuoshuliang = true;
            continue;
          }
	            	            if(o=='gongyingshangkucun'){
            this.ruleForm.gongyingshangkucun = obj[o];
	    this.ro.gongyingshangkucun = true;
            continue;
          }
	            	            if(o=='thumbsupnum'){
