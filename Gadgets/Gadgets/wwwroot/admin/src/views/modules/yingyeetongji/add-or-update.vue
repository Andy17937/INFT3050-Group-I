          ...
          <el-form-item class="input" v-if="ruleForm.shijian" label="时间" prop="shijian">
              <el-input v-model="ruleForm.shijian" 
                placeholder="时间" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="收入" prop="shouru">
          <el-input v-model="ruleForm.shouru" 
              placeholder="收入" clearable  :readonly="ro.shouru"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="收入" prop="shouru">
              <el-input v-model="ruleForm.shouru" 
                placeholder="收入" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="支出" prop="zhichu">
          <el-input v-model="ruleForm.zhichu" 
              placeholder="支出" clearable  :readonly="ro.zhichu"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="支出" prop="zhichu">
              <el-input v-model="ruleForm.zhichu" 
                placeholder="支出" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'" label="营业额" prop="yingyee">
            <el-input v-model="yingyee"
                placeholder="营业额" readonly></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.yingyee" label="营业额" prop="yingyee">
              <el-input v-model="ruleForm.yingyee" 
                placeholder="营业额" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
...
export default {
  ...
  computed: {
                                                    yingyee: {
                                                                                                                    get: function () {
        return 0+parseFloat(this.ruleForm.shouru==""?0:this.ruleForm.shouru)-parseFloat(this.ruleForm.zhichu==""?0:this.ruleForm.zhichu) || 0
      }
    },
          },
  created() {
  ...
  methods: {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.shijian = true;
            continue;
	            	            ...
	            	            if(o=='shouru'){
            this.ruleForm.shouru = obj[o];
	    this.ro.shouru = true;
            continue;
          }
	            	            if(o=='zhichu'){
            this.ruleForm.zhichu = obj[o];
	    this.ro.zhichu = true;
            continue;
          }
	            	            if(o=='yingyee'){
            this.ruleForm.yingyee = obj[o];
	    this.ro.yingyee = true;
            continue;
          }
	                    }
                                                                              }
    ...
    onSubmit() {
                  // ${column.compare}
                              ...
                              // ${column.compare}
                              // ${column.compare}
              this.ruleForm.yingyee = this.yingyee
                                                                                                            this.$refs["ruleForm"].validate(valid => {
        if (valid) {
          this.$http({
            url: `yingyeetongji/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.yingyeetongjiCrossAddOrUpdateFlag = false;
                  this.parent.search();
