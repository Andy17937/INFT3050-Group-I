<template>
  <div class="addEdit-block">
    ...
    >
      <el-row>
                        <el-col :span="12">
        <el-form-item class="date" v-if="type!='info'" label="年份" prop="nianfen">
            <el-date-picker
                format="yyyy 年 MM 月 dd 日"
                value-format="yyyy-MM-dd"
                v-model="ruleForm.nianfen" 
                type="date"
                placeholder="年份">
            </el-date-picker> 
        </el-form-item>
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.nianfen" label="年份" prop="nianfen">
        ...
        <div v-else>
          <el-form-item v-if="ruleForm.shangpintupian" label="Item图片" prop="shangpintupian">
            <img style="margin-right:20px;" v-bind:key="index" v-for="(item,index) in ruleForm.shangpintupian.split(',')" :src="item" width="100" height="100">
                                    ...
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="ItemPrice" prop="shangpinjiage">
          <el-input v-model="ruleForm.shangpinjiage" 
              placeholder="ItemPrice" clearable  :readonly="ro.shangpinjiage"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="ItemPrice" prop="shangpinjiage">
              <el-input v-model="ruleForm.shangpinjiage" 
                placeholder="ItemPrice" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
          ...
          <el-form-item class="input" label="Category" prop="shangpinfenlei">
              <el-input v-model="ruleForm.shangpinfenlei" 
                placeholder="Category" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="Item销量" prop="shangpinxiaoliang">
          <el-input v-model="ruleForm.shangpinxiaoliang" 
              placeholder="Item销量" clearable  :readonly="ro.shangpinxiaoliang"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="Item销量" prop="shangpinxiaoliang">
              <el-input v-model="ruleForm.shangpinxiaoliang" 
                placeholder="Item销量" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="Sales金额" prop="xiaoshoujine">
          <el-input v-model="ruleForm.xiaoshoujine" 
              placeholder="Sales金额" clearable  :readonly="ro.xiaoshoujine"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="Sales金额" prop="xiaoshoujine">
              <el-input v-model="ruleForm.xiaoshoujine" 
                placeholder="Sales金额" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                              </el-row>
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.shangpinfenlei = true;
            continue;
	            	            ...
	            	            if(o=='shangpinxiaoliang'){
            this.ruleForm.shangpinxiaoliang = obj[o];
	    this.ro.shangpinxiaoliang = true;
            continue;
          }
	            	            if(o=='xiaoshoujine'){
