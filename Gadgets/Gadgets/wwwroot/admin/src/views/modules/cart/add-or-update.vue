          ...
          <el-form-item class="input" label="Itemtable name" prop="tablename">
              <el-input v-model="ruleForm.tablename" 
                placeholder="Itemtable name" readonly></el-input>
                                                                  ...
                                                                  <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="Itemid" prop="goodid">
          <el-input v-model="ruleForm.goodid" 
              placeholder="Itemid" clearable  :readonly="ro.goodid"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="Itemid" prop="goodid">
              <el-input v-model="ruleForm.goodid" 
                placeholder="Itemid" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
          ...
          <el-form-item class="input" label="单价" prop="price">
              <el-input v-model="ruleForm.price" 
                placeholder="单价" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="Member价" prop="discountprice">
          <el-input v-model="ruleForm.discountprice" 
              placeholder="Member价" clearable  :readonly="ro.discountprice"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="Member价" prop="discountprice">
              <el-input v-model="ruleForm.discountprice" 
                placeholder="Member价" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                              </el-row>
