<template>
  <div class="addEdit-block">
    ...
    >
      <el-row>
                        <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="Member Name" prop="huiyuanming">
          <el-input v-model="ruleForm.huiyuanming" 
              placeholder="Member Name" clearable  :readonly="ro.huiyuanming"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="Member Name" prop="huiyuanming">
              <el-input v-model="ruleForm.huiyuanming" 
        ...
        <el-form-item class="input" v-if="type!='info'"  label="Phone" prop="shouji">
          <el-input v-model="ruleForm.shouji" 
              placeholder="Phone" clearable  :readonly="ro.shouji"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="Phone" prop="shouji">
              <el-input v-model="ruleForm.shouji" 
                placeholder="Phone" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
          ...
          <el-form-item class="input" label="Name" prop="xingming">
              <el-input v-model="ruleForm.xingming" 
                placeholder="Name" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="Address" prop="shenfenzheng">
          <el-input v-model="ruleForm.shenfenzheng" 
              placeholder="Address" clearable  :readonly="ro.shenfenzheng"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="Address" prop="shenfenzheng">
              <el-input v-model="ruleForm.shenfenzheng" 
            ...
            ruleForm: {
                	        huiyuanming: '',
	                        	        ...
	                        	        shenfenzheng: '',
                                                                                                              ...
                                                                                                              rules: {
                  huiyuanming: [
                            { required: true, message: 'Member Name不能为空', trigger: 'blur' },
                                    	                                                              ],
                  mima: [
