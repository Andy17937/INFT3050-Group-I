          ...
          <el-form-item class="input" label="Password" prop="mima">
              <el-input v-model="ruleForm.mima" 
                placeholder="Password" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="Name" prop="name">
          <el-input v-model="ruleForm.name" 
              placeholder="Name" clearable  :readonly="ro.name"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="Name" prop="name">
              <el-input v-model="ruleForm.name" 
        ...
        <div v-else>
          <el-form-item v-if="ruleForm.picture" label="照片" prop="picture">
            <img style="margin-right:20px;" v-bind:key="index" v-for="(item,index) in ruleForm.picture.split(',')" :src="item" width="100" height="100">
                                    ...
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="Email" prop="email">
          <el-input v-model="ruleForm.email" 
              placeholder="Email" clearable  :readonly="ro.email"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="Email" prop="email">
              <el-input v-model="ruleForm.email" 
