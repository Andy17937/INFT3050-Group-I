<template>
  <div class="addEdit-block">
    ...
    >
      <el-row>
                        <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'" label="Staff号" prop="yuangonghao">
          <el-select  @change="yuangonghaoChange" v-model="ruleForm.yuangonghao" placeholder="请OptionStaff号">
            <el-option
                v-for="(item,index) in yuangonghaoOptions"
                v-bind:key="index"
                :label="item"
                :value="item">
            </el-option>
        ...
        <div v-else>
          <el-form-item class="input"v-if="ruleForm.yuangonghao" label="Staff号" prop="yuangonghao">
              <el-input v-model="ruleForm.yuangonghao" 
                placeholder="Staff号" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
          ...
          <el-form-item class="input" v-if="ruleForm.qiandaoshijian" label="签到时间" prop="qiandaoshijian">
              <el-input v-model="ruleForm.qiandaoshijian" 
                placeholder="签到时间" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="AttendanceStatus" prop="kaoqinzhuangtai">
          <el-select v-model="ruleForm.kaoqinzhuangtai" placeholder="请OptionAttendanceStatus">
            <el-option
        ...
        <div v-else>
          <el-form-item class="input" label="AttendanceStatus" prop="kaoqinzhuangtai">
	      <el-input v-model="ruleForm.kaoqinzhuangtai"
                placeholder="AttendanceStatus" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
      ...
      this.$http({
        ...
        if (data && data.code === 0) {
          ...
          this.$message.error(data.msg);
                                          ...
                                          this.$http({
              url: `option/yuangong/yuangonghao`,
              method: "get"
            }).then(({ data }) => {
              if (data && data.code === 0) {
                this.yuangonghaoOptions = data.data;
              } else {
                this.$message.error(data.msg);
              }
            });
                                                                            this.kaoqinzhuangtaiOptions = "迟到,未迟到".split(',')
                                              },
            // 下二随
    yuangonghaoChange () {
      this.$http({
        url: `follow/yuangong/yuangonghao?columnValue=`+ this.ruleForm.yuangonghao,
        method: "get"
      }).then(({ data }) => {
        if (data && data.code === 0) {
