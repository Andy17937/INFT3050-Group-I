  ...
  <div class="addEdit-block">
    ...
    >
      <el-row>
          ...
          <el-form-item class="input" v-if="ruleForm.shijian" label="时间" prop="shijian">
              <el-input v-model="ruleForm.shijian" 
                placeholder="时间" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'" label="Member Name" prop="huiyuanming">
          <el-select  @change="huiyuanmingChange" v-model="ruleForm.huiyuanming" placeholder="请OptionMember Name">
            <el-option
                v-for="(item,index) in huiyuanmingOptions"
                v-bind:key="index"
                :label="item"
                :value="item">
            </el-option>
        ...
        <div v-else>
          <el-form-item class="input"v-if="ruleForm.huiyuanming" label="Member Name" prop="huiyuanming">
              <el-input v-model="ruleForm.huiyuanming" 
                placeholder="Member Name" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
          ...
          <el-form-item class="input" v-if="ruleForm.tuihuoshijian" label="退货时间" prop="tuihuoshijian">
              <el-input v-model="ruleForm.tuihuoshijian" 
                placeholder="退货时间" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="Return Reason" prop="tuihuoliyou">
          <el-input v-model="ruleForm.tuihuoliyou" 
              placeholder="Return Reason" clearable  :readonly="ro.tuihuoliyou"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="Return Reason" prop="tuihuoliyou">
              <el-input v-model="ruleForm.tuihuoliyou" 
                placeholder="Return Reason" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="Return Status" prop="tuihuozhuangtai">
          <el-select v-model="ruleForm.tuihuozhuangtai" placeholder="请OptionReturn Status">
            <el-option
                v-for="(item,index) in tuihuozhuangtaiOptions"
                v-bind:key="index"
                :label="item"
                :value="item">
            </el-option>
        ...
        <div v-else>
          <el-form-item class="input" label="Return Status" prop="tuihuozhuangtai">
	      <el-input v-model="ruleForm.tuihuozhuangtai"
                placeholder="Return Status" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                              </el-row>
...
export default {
  ...
  methods: {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.shijian = true;
            continue;
	            	            ...
	            	            if(o=='huiyuanming'){
            this.ruleForm.huiyuanming = obj[o];
	    this.ro.huiyuanming = true;
            continue;
          }
	            	            if(o=='xingming'){
	    ...
	    this.ro.tuihuoshijian = true;
            continue;
	            	            ...
	            	            if(o=='tuihuoliyou'){
            this.ruleForm.tuihuoliyou = obj[o];
	    this.ro.tuihuoliyou = true;
            continue;
          }
	            	            if(o=='tuihuozhuangtai'){
            this.ruleForm.tuihuozhuangtai = obj[o];
	    this.ro.tuihuozhuangtai = true;
            continue;
          }
	                    }
                                                                                                              }
      ...
      this.$http({
        ...
        if (data && data.code === 0) {
          ...
          this.$message.error(data.msg);
                                                            ...
                                                            this.$http({
              url: `option/huiyuan/huiyuanming`,
              method: "get"
            }).then(({ data }) => {
              if (data && data.code === 0) {
                this.huiyuanmingOptions = data.data;
              } else {
                this.$message.error(data.msg);
              }
            });
                                                                                              this.tuihuozhuangtaiOptions = "Unreturned,Returned".split(',')
                            },
                    // 下二随
    huiyuanmingChange () {
      this.$http({
        url: `follow/huiyuan/huiyuanming?columnValue=`+ this.ruleForm.huiyuanming,
        method: "get"
      }).then(({ data }) => {
        if (data && data.code === 0) {
    ...
    onSubmit() {
        ...
        if (valid) {
          this.$http({
            url: `tuihuoguanli/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.tuihuoguanliCrossAddOrUpdateFlag = false;
                  this.parent.search();
