          ...
          <el-form-item class="input" label="电话" prop="phone">
              <el-input v-model="ruleForm.phone" 
                placeholder="电话" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="YesNoDefaultAddress[Yes/No]" prop="isdefault">
          <el-input v-model="ruleForm.isdefault" 
              placeholder="YesNoDefaultAddress[Yes/No]" clearable  :readonly="ro.isdefault"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="YesNoDefaultAddress[Yes/No]" prop="isdefault">
              <el-input v-model="ruleForm.isdefault" 
                placeholder="YesNoDefaultAddress[Yes/No]" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                              </el-row>
  ...
  data() {
	...
	isdefault : false,
            ...
            ruleForm: {
                  ...
                  isdefault: [
                            { required: true, message: 'YesNoDefaultAddress[Yes/No]不能为空', trigger: 'blur' },
                                    	                                                              ],
              }
    };
  },
