<template>
  <div class="addEdit-block">
    ...
    >
      <el-row>
                        <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="Staff号" prop="yuangonghao">
          <el-input v-model="ruleForm.yuangonghao" 
              placeholder="Staff号" clearable  :readonly="ro.yuangonghao"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="Staff号" prop="yuangonghao">
              <el-input v-model="ruleForm.yuangonghao" 
            ...
            ruleForm: {
                	        yuangonghao: '',
	                        	        ...
	                        	        shenfenzheng: '',
                                                                                                              ...
                                                                                                              rules: {
                  yuangonghao: [
                            { required: true, message: 'Staff号不能为空', trigger: 'blur' },
                                    	                                                              ],
                  mima: [
