  ...
  <div class="addEdit-block">
    ...
    >
      <el-row>
          ...
          <el-form-item class="input" label="表名" prop="tablename">
              <el-input v-model="ruleForm.tablename" 
                placeholder="表名" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="Favorite Item Name" prop="name">
          <el-input v-model="ruleForm.name" 
              placeholder="Favorite Item Name" clearable  :readonly="ro.name"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="Favorite Item Name" prop="name">
              <el-input v-model="ruleForm.name" 
                placeholder="Favorite Item Name" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="24">  
        <el-form-item class="upload" v-if="type!='info' && !ro.picture" label="Item Picture" prop="picture">
          <file-upload
          tip="点击上传Item Picture"
          action="file/upload"
          :limit="3"
          :multiple="true"
        ...
        <div v-else>
          <el-form-item v-if="ruleForm.picture" label="Item Picture" prop="picture">
  ...
  data() {
	...
	picture : false,
            ...
            ruleForm: {
                  ...
                  name: [
                            { required: true, message: 'Favorite Item Name不能为空', trigger: 'blur' },
                                    	                                                              ],
                  picture: [
                            { required: true, message: 'Item Picture不能为空', trigger: 'blur' },
                                    	                                                              ],
              }
    };
  },
