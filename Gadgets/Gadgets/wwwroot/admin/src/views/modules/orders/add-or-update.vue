<template>
  <div class="addEdit-block">
    ...
    >
      <el-row>
                        <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'" label="Order #" prop="orderid">
            <el-input v-model="ruleForm.orderid" 
                placeholder="Order #" readonly></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.orderid" label="Order #" prop="orderid">
              <el-input v-model="ruleForm.orderid" 
                placeholder="Order #" readonly></el-input>
          </el-form-item>
        </div>
                                                                        ...
                                                                        <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="ItemName" prop="goodname">
          <el-input v-model="ruleForm.goodname" 
              placeholder="ItemName" clearable  :readonly="ro.goodname"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="ItemName" prop="goodname">
              <el-input v-model="ruleForm.goodname" 
                placeholder="ItemName" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="24">  
        <el-form-item class="upload" v-if="type!='info' && !ro.picture" label="Item图片" prop="picture">
          <file-upload
          tip="点击上传Item图片"
          action="file/upload"
          :limit="3"
        ...
        <div v-else>
          <el-form-item v-if="ruleForm.picture" label="Item图片" prop="picture">
            <img style="margin-right:20px;" v-bind:key="index" v-for="(item,index) in ruleForm.picture.split(',')" :src="item" width="100" height="100">
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="Item Amount" prop="buynumber">
          <el-input v-model="ruleForm.buynumber" 
              placeholder="Item Amount" clearable  :readonly="ro.buynumber"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="Item Amount" prop="buynumber">
              <el-input v-model="ruleForm.buynumber" 
                placeholder="Item Amount" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="Price/Credit" prop="price">
          <el-input v-model="ruleForm.price" 
              placeholder="Price/Credit" clearable  :readonly="ro.price"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="Price/Credit" prop="price">
              <el-input v-model="ruleForm.price" 
                placeholder="Price/Credit" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="Discount Price" prop="discountprice">
          <el-input v-model="ruleForm.discountprice" 
              placeholder="Discount Price" clearable  :readonly="ro.discountprice"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="Discount Price" prop="discountprice">
              <el-input v-model="ruleForm.discountprice" 
                placeholder="Discount Price" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="Total Price/Credit" prop="total">
          <el-input v-model="ruleForm.total" 
              placeholder="Total Price/Credit" clearable  :readonly="ro.total"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="Total Price/Credit" prop="total">
              <el-input v-model="ruleForm.total" 
                placeholder="Total Price/Credit" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="Total Discount Price" prop="discounttotal">
          <el-input v-model="ruleForm.discounttotal" 
              placeholder="Total Discount Price" clearable  :readonly="ro.discounttotal"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="Total Discount Price" prop="discounttotal">
              <el-input v-model="ruleForm.discounttotal" 
                placeholder="Total Discount Price" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="Payment Method" prop="type">
          <el-select v-model="ruleForm.type" placeholder="请OptionPay类型">
            <el-option
        ...
        <div v-else>
          <el-form-item class="input" label="Payment Method" prop="type">
	      <el-input v-model="ruleForm.type-0==1?'Cash':'积分'"
                placeholder="Payment Method" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="Status" prop="status">
          <el-select v-model="ruleForm.status" placeholder="请OptionStatus">
            <el-option
        ...
        <div v-else>
          <el-form-item class="input" label="Status" prop="status">
	      <el-input v-model="ruleForm.status"
                placeholder="Status" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="Address" prop="address">
          <el-input v-model="ruleForm.address" 
              placeholder="Address" clearable  :readonly="ro.address"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="Address" prop="address">
              <el-input v-model="ruleForm.address" 
  ...
  data() {
    ...
    var validateIdCard = (rule, value, callback) => {
      if(!value){
        ...
        callback(new Error("请输入正确的Address号码"));
      } else {
        callback();
      }
    };
    ...
    var validateEmail = (rule, value, callback) => {
      if(!value){
        ...
        callback(new Error("请输入正确的EmailAddress"));
      } else {
        callback();
      }
    };
            ...
            ruleForm: {
                        orderid: this.getUUID(),
                                ...
                                statusOptions: [],
                                  rules: {
                  orderid: [
                            { required: true, message: 'Order #不能为空', trigger: 'blur' },
                                    	                                                              ],
                  tablename: [
                                    	                                                              ],
                  userid: [
                  ...
                  price: [
                            { required: true, message: 'Price/Credit不能为空', trigger: 'blur' },
                  ...
                  total: [
                            { required: true, message: 'Total Price/Credit不能为空', trigger: 'blur' },
                                                    { validator: validateNumber, trigger: 'blur' },
            	                                                              ],
                  discounttotal: [
                                                    { validator: validateNumber, trigger: 'blur' },
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.address = true;
            continue;
                                        ...
                                        this.statusOptions = "Unpaid,Paid,Completed,Cancelled,Refunded,Shipped".split(',')
                                              },
                                                                                                                        // 多级联动参数
                                                                                                                                                        info(id) {
      this.$http({
