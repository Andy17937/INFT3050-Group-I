          ...
          <el-form-item class="input" v-if="ruleForm.jinhuoshijian" label="进货时间" prop="jinhuoshijian">
              <el-input v-model="ruleForm.jinhuoshijian" 
                placeholder="进货时间" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="进货Amount" prop="jinhuoshuliang">
          <el-input v-model="ruleForm.jinhuoshuliang" 
              placeholder="进货Amount" clearable  :readonly="ro.jinhuoshuliang"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="进货Amount" prop="jinhuoshuliang">
              <el-input v-model="ruleForm.jinhuoshuliang" 
                placeholder="进货Amount" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="进货金额" prop="jinhuojine">
          <el-input v-model="ruleForm.jinhuojine" 
              placeholder="进货金额" clearable  :readonly="ro.jinhuojine"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="进货金额" prop="jinhuojine">
              <el-input v-model="ruleForm.jinhuojine" 
                placeholder="进货金额" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                              </el-row>
...
export default {
  ...
  methods: {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.jinhuoshijian = true;
            continue;
	            	            ...
	            	            if(o=='jinhuoshuliang'){
            this.ruleForm.jinhuoshuliang = obj[o];
	    this.ro.jinhuoshuliang = true;
            continue;
          }
	            	            if(o=='jinhuojine'){
            this.ruleForm.jinhuojine = obj[o];
	    this.ro.jinhuojine = true;
            continue;
          }
	                    }
                                                                                                                              }
    ...
    onSubmit() {
        ...
        if (valid) {
          this.$http({
            url: `xiaoshouguanli/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.xiaoshouguanliCrossAddOrUpdateFlag = false;
                  this.parent.search();
