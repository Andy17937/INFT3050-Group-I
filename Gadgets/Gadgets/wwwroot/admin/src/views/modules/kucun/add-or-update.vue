          ...
          <el-form-item class="input" label="ItemName" prop="shangpinmingcheng">
              <el-input v-model="ruleForm.shangpinmingcheng" 
                placeholder="ItemName" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="Item类别" prop="shangpinleibie">
          <el-input v-model="ruleForm.shangpinleibie" 
              placeholder="Item类别" clearable  :readonly="ro.shangpinleibie"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="Item类别" prop="shangpinleibie">
              <el-input v-model="ruleForm.shangpinleibie" 
                placeholder="Item类别" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="24">  
          ...
          <el-form-item class="input" v-if="ruleForm.chukushijian" label="出库时间" prop="chukushijian">
              <el-input v-model="ruleForm.chukushijian" 
                placeholder="出库时间" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="入库Amount" prop="rukushuliang">
          <el-input v-model="ruleForm.rukushuliang" 
              placeholder="入库Amount" clearable  :readonly="ro.rukushuliang"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="入库Amount" prop="rukushuliang">
              <el-input v-model="ruleForm.rukushuliang" 
                placeholder="入库Amount" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="出库Amount" prop="chukushuliang">
          <el-input v-model="ruleForm.chukushuliang" 
              placeholder="出库Amount" clearable  :readonly="ro.chukushuliang"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="出库Amount" prop="chukushuliang">
              <el-input v-model="ruleForm.chukushuliang" 
                placeholder="出库Amount" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'" label="Inventories总量" prop="kucunzongliang">
            <el-input v-model="kucunzongliang"
                placeholder="Inventories总量" readonly></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.kucunzongliang" label="Inventories总量" prop="kucunzongliang">
              <el-input v-model="ruleForm.kucunzongliang" 
                placeholder="Inventories总量" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
...
export default {
  ...
  computed: {
                                                                                                    kucunzongliang: {
                                                                                                                                                                                                            get: function () {
        return 0+parseFloat(this.ruleForm.rukushuliang==""?0:this.ruleForm.rukushuliang)-parseFloat(this.ruleForm.chukushuliang==""?0:this.ruleForm.chukushuliang) || 0
      }
    },
          },
  created() {
  ...
  methods: {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.chukushuliang = true;
            continue;
	            	            ...
	            	            if(o=='kucunzongliang'){
            this.ruleForm.kucunzongliang = obj[o];
	    this.ro.kucunzongliang = true;
            continue;
          }
	                    }
                                                                                                                                              }
    ...
    onSubmit() {
                  // ${column.compare}
                              ...
                              // ${column.compare}
                              // ${column.compare}
              this.ruleForm.kucunzongliang = this.kucunzongliang
                                                                                                                                                                                    this.$refs["ruleForm"].validate(valid => {
        if (valid) {
          this.$http({
            url: `kucun/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.kucunCrossAddOrUpdateFlag = false;
                  this.parent.search();
