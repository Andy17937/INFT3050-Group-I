...
(function (factory) {
    ...
    function buildBootstrapModalHTML() {
        var toolsHtml = '<div class="btn-group">'
            + '<button id="idAMapPositionPickerLocation" type="button" class="btn btn-default btn-sm"><span class="glyphicon glyphicon-map-marker"></span>&nbsp;Locate</button>'
            ...
            + '<button id="idAMapPositionPickerClear" type="button" class="btn btn-default btn-sm"><span class="glyphicon glyphicon-remove"></span>&nbsp;Clean</button>'
        ...
        var modalHtml = '<div class="modal fade" id="idAMapPositionPickerModal">'
            ...
            + '<div class="modal-header"><button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">&times;</span><span class="sr-only">Close</span></button><h4 class="modal-title">Please Select Address</h4><small id="idAMapPositionPickerAlert" style="color: red">必须Option一个位置</small></div>'
            ...
            + '<button id="idAMapPositionPickerSelect" type="button" class="btn btn-primary btn-sm">Yes</button><button id="idAMapPositionPickerCancelBtn" type="button" class="btn btn-default btn-sm" data-dismiss="modal">Cancel</button>'
                    ...
                    AMap.service('AMap.PlaceSearch', function () {
                        ...
                        placeSearch.searchInBounds(searchKeyword, mapObj.getBounds(), function (status, result) {
                            ...
                            if (status == 'complete') {
                                ...
                                $searchPanel.append('<li class="list-group-item disabled"><small>抱歉，暂无找到符合Result件的结果。</small></li>');
                            }
                        });
                    });
                }
    ...
    $.fn.AMapPositionPicker.defaults = {
        ...
        errorTip: 'Please Select Address',
        height: '500px',
        fields: []
    };
